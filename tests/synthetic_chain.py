...
def build_synthetic_chain(
    *,
    ...
    forward.py's own already-tested parity derivation. index_prices is set
    equal to the forward so implied_rate resolves to exactly 0.0
    (log(F/S)/tau = log(1)/tau = 0), keeping the discount factor trivial.
    """
